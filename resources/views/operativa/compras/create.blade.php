...
@section('page_subtitle', 'Gestión Operativa · Registrar compra (Almacén Central)')

@section('content')
<div class="container-fluid" style="max-width:700px;">
    <h4 class="fw-light text-secondary mb-3">Nueva Orden de Compra</h4>
    <p class="text-muted small">Toda compra ingresa al almacén central. El proyecto destino se asigna después, al registrar el uso del material desde Inventario.</p>
    <hr>
